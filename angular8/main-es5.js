...
var AddDepComponent = /** @class */ (function () {
    function AddDepComponent(dialogbox, service, snackBar) {
    ...
    AddDepComponent.prototype.resetForm = function (form) {
        if (form != null)
            form.resetForm();
        this.service.formData = { DepartmentID: 0, DepartmentName: '' };
    };
    AddDepComponent.prototype.onClose = function () {
        this.dialogbox.close();
        this.service.filter('Register click');
    };
    AddDepComponent.prototype.onSubmit = function (form) {
        var _this = this;
        console.log(form.value);
        this.service.addDepartment(form.value).subscribe(function (res) {
            _this.resetForm();
            _this.snackBar.open(res.toString(), '', { duration: 3000, verticalPosition: 'top' });
            //alert(res);
        });
    };
...
var EditDepComponent = /** @class */ (function () {
    function EditDepComponent(dialogbox, service, snackBar) {
        this.dialogbox = dialogbox;
        this.service = service;
        this.snackBar = snackBar;
    }
    EditDepComponent.prototype.ngOnInit = function () {
    };
    EditDepComponent.prototype.onClose = function () {
        this.dialogbox.close();
        this.service.filter('Register click');
    };
    EditDepComponent.prototype.onSubmit = function (form) {
        var _this = this;
        this.service.updateDepartment(form.value).subscribe(function (res) {
            _this.snackBar.open(res.toString(), '', { duration: 5000,
                verticalPosition: 'top' });
        });
    };
    EditDepComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: src_app_services_department_service__WEBPACK_IMPORTED_MODULE_3__["DepartmentService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
...
var ShowDepComponent = /** @class */ (function () {
    function ShowDepComponent(service, dialog, snackBar) {
        var _this = this;
        this.service = service;
        this.dialog = dialog;
        this.snackBar = snackBar;
        this.displayedColumns = ['Options', 'DepartmentID', 'DepartmentName'];
        this.service.listen().subscribe(function (m) {
            console.log(m);
            _this.refreshDepList;
        });
    }
    ShowDepComponent.prototype.ngOnInit = function () {
        this.refreshDepList();
    };
    ShowDepComponent.prototype.refreshDepList = function () {
        ...
        this.service.getDepList().subscribe(function (data) {
            _this.listData = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](data);
            _this.listData.sort = _this.sort;
        });
    };
    ShowDepComponent.prototype.applyFilter = function (filtervalue) {
        this.listData.filter = filtervalue.trim().toLocaleLowerCase();
    };
    ShowDepComponent.prototype.onEdit = function (dep) {
    ...
    ShowDepComponent.prototype.onDelete = function (id) {
        var _this = this;
        //console.log(id);
        if (confirm('Are you sure to delete??')) {
            this.service.deleteDepartment(id).subscribe(function (res) {
                _this.refreshDepList();
                _this.snackBar.open(res.toString(), '', { duration: 5000, verticalPosition: 'top' });
            });
        }
    };
    ShowDepComponent.prototype.onAdd = function () {
        var dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogConfig"]();
        dialogConfig.disableClose = true;
        dialogConfig.autoFocus = true;
        dialogConfig.width = "70%";
    ...
    ShowDepComponent.ctorParameters = function () { return [
        { type: src_app_services_department_service__WEBPACK_IMPORTED_MODULE_3__["DepartmentService"] },
...
var AddEmpComponent = /** @class */ (function () {
    function AddEmpComponent(dialogbox, service, snackBar) {
        this.dialogbox = dialogbox;
        this.service = service;
        this.snackBar = snackBar;
        this.listItems = [];
    ...
    AddEmpComponent.prototype.dropdownRefresh = function () {
        var _this = this;
        this.service.getDepDropDownValues().subscribe(function (data) {
            console.log(data);
            data.forEach(function (element) {
                _this.listItems.push(element["DepartmentName"]);
            });
        });
    };
    AddEmpComponent.prototype.resetForm = function (form) {
        if (form != null)
            form.resetForm();
    ...
    AddEmpComponent.prototype.onClose = function () {
        this.dialogbox.close();
        this.service.filter('Register click');
    };
    AddEmpComponent.prototype.onSubmit = function (form) {
    ...
    AddEmpComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
var EditEmpComponent = /** @class */ (function () {
    function EditEmpComponent(dialogbox, service, snackBar) {
        this.dialogbox = dialogbox;
        this.service = service;
        this.snackBar = snackBar;
        this.listItems = [];
    ...
    EditEmpComponent.prototype.onClose = function () {
        this.dialogbox.close();
        this.service.filter('Register click');
    };
    EditEmpComponent.prototype.dropdownRefresh = function () {
        var _this = this;
        this.service.getDepDropDownValues().subscribe(function (data) {
            console.log(data);
            data.forEach(function (element) {
    ...
    EditEmpComponent.prototype.onSubmit = function (form) {
        form.value.DOJ = new Date(form.value.DOJ).getFullYear().toString()
            + '-' + (new Date(form.value.DOJ).getMonth() + 1).toString()
            + '-' + new Date(form.value.DOJ).getDate().toString();
    ...
    EditEmpComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: src_app_services_employee_service__WEBPACK_IMPORTED_MODULE_3__["EmployeeService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
...
var ShowEmpComponent = /** @class */ (function () {
    function ShowEmpComponent(service, dialog, snackBar) {
        var _this = this;
        this.service = service;
        this.dialog = dialog;
        this.snackBar = snackBar;
        ...
        this.service.listen().subscribe(function (m) {
            console.log(m);
            _this.refreshEmpList();
        });
    }
    ShowEmpComponent.prototype.ngOnInit = function () {
        this.refreshEmpList();
    };
    ShowEmpComponent.prototype.onEdit = function (emp) {
    ...
    ShowEmpComponent.prototype.applyFilter = function (filtervalue) {
        this.listData.filter = filtervalue.trim().toLocaleLowerCase();
    };
    ShowEmpComponent.prototype.refreshEmpList = function () {
    ...
    ShowEmpComponent.prototype.onDelete = function (id) {
        if (confirm('Are you sure to delete??')) {
    ...
    ShowEmpComponent.prototype.onAdd = function () {
        var dialogConfig = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogConfig"]();
        dialogConfig.disableClose = true;
        dialogConfig.autoFocus = true;
        dialogConfig.width = "70%";
    ...
    ShowEmpComponent.ctorParameters = function () { return [
        { type: src_app_services_employee_service__WEBPACK_IMPORTED_MODULE_3__["EmployeeService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
...
var DepartmentService = /** @class */ (function () {
    ...
    DepartmentService.prototype.getDepList = function () {
        return this.http.get('https://run.mocky.io/v3/6e245b7a-749b-4964-bd85-2e561efda086');
    };
    DepartmentService.prototype.addDepartment = function (dep) {
    ...
    DepartmentService.prototype.updateDepartment = function (dep) {
        return this.http.put('https://run.mocky.io/v3/6e245b7a-749b-4964-bd85-2e561efda086', 'dep');
    };
    DepartmentService.prototype.listen = function () {
        return this._listners.asObservable();
    };
    DepartmentService.prototype.filter = function (filterBy) {
...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.getEmpList = function () {
    ...
    EmployeeService.prototype.deleteEmployee = function (id) {
        this.listData.data.splice(this.listData.data.findIndex(function (x) { return x.EmployeeID === id; }, 1), 1);
    };
    EmployeeService.prototype.updateEmployee = function (emp) {
        this.index = this.listData.data.findIndex(function (x) { return x.EmployeeID === emp.EmployeeID; }, 1);
    ...
    EmployeeService.prototype.getDepDropDownValues = function () {
        return this.http.get('https://run.mocky.io/v3/6e245b7a-749b-4964-bd85-2e561efda086');
    };
    EmployeeService.prototype.listen = function () {
        return this._listners.asObservable();
    };
    EmployeeService.prototype.filter = function (filterBy) {
        this._listners.next(filterBy);
    };
